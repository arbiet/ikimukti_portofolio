...
export default defineUserConfig({
  ...
  head: [
    ...
    ['script', { async: true, src: 'https://news.google.com/swg/js/v1/swg-basic.js', type: 'text/javascript' }],
    ['script', {}, `
  ...
  plugins: [
    ...
    pwaPlugin({
      ...
      manifest: {
        ...
        description: 'ikimukticom - Your Digital Productivity Hub',
        display: 'standalone',
        features: ['external', 'offline', 'push notifications'],
        icons: [
          {
            src: '/image/maskable-icon-192x192.png',
            sizes: '192x192',
            type: 'image/png',
            purpose: 'maskable',
          },
